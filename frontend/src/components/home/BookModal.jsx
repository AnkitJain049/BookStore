  ...
  return (
    ...
    >
      <div
        ...
        className='w-[600px] max-w-full h-[400px] bg-gray-900 text-white rounded-xl p-4 flex flex-col relative'
      >
        <AiOutlineClose
        ...
        <div className='flex justify-start items-center gap-x-2'>
          ...
          <h2 className='my-1 overflow-hidden text-ellipsis whitespace-nowrap'>{book.title}</h2>
        </div>
        <div className='flex justify-start items-center gap-x-2'>
          <BiUserCircle className='text-blue-400 text-2xl' />
          <h2 className='my-1 overflow-hidden text-ellipsis whitespace-nowrap'>{book.author}</h2>
        </div>
